...
describe Occurrence do
  ...
  describe "#symbolicate!" do
    before(:each) do
      ...
      @occurrence.bug.environment.project.instance_variable_set :@repo, Squash::Project.new { |pp| pp.repository_url = 'git@github.com:RISCfuture/better_caller.git' }.repo
